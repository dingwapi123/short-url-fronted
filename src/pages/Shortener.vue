...
<template>
  <div class="max-w-[860px] mx-auto my-8 px-5">
    <div class="card bg-base-100 border border-base-300 shadow-sm p-5 transition-all duration-300">
      ...
      <div class="grid gap-4">
        <div class="form-control">
          ...
          <div class="flex justify-between items-center mt-2">
            ...
            <button v-if="originalUrl" class="btn btn-ghost btn-xs" @click="clearForm">清空</button>
          </div>
        </div>
